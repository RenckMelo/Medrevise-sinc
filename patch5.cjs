...
code = code.replace('export const markdownComponents: any = {', () => newComponent + '\n\nexport const markdownComponents: any = {');
...
const newOuter = `    if (isLightTextType) {
      return (
        <div className="my-8 border border-slate-200 bg-white rounded-3xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] overflow-hidden">
