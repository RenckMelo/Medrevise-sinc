...
export default function AiProviderStatusModal({ isOpen, onClose, userEmail }: AiProviderStatusModalProps) {
  ...
  const isSpecialUser = userEmail === 'lucas1renck2melo@gmail.com' || userEmail === 'ysabelleosaraiva@gmail.com' || userEmail === 'yasabelleosaraiva@gmail.com';
  const isOwner = userEmail === 'lucas1renck2melo@gmail.com';
  ...
  } else if (userLimit >= 120) {
    planName = "Plano MedRevise Pro";
    groqAllowedDaily = 500;
    groqRPM = 30;
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto animate-in fade-in duration-200">
      <div className="bg-white rounded-3xl max-w-4xl w-full p-6 sm:p-8 shadow-2xl border border-[#E2E0D9] relative my-8">
        
        {/* Header */}
        <div className="flex items-start justify-between pb-5 border-b border-[#E2E0D9]">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-xl font-black text-[#1A1A1A] tracking-tight">
                  {isOwner ? "Status & Escolha da IA" : "Saldo & Limites de Inteligência Artificial"}
                </h2>
                {isOwner && (
              ...
              <p className="text-xs text-[#6E6A62] mt-0.5 font-medium">
                {isOwner 
                  ...
                  : "Acompanhe seus créditos diários e o consumo de IA por funcionalidade."
                }
              </p>
            </div>
          </div>
        ...
        {stats && isOwner && (
          <div className="my-5 p-4 rounded-2xl bg-slate-900 text-white flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 shadow-md">
            <div className="flex items-center gap-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5 pt-1">
              ...
              >
                ...
                <p className={`text-[10px] leading-snug ${preferredEngine === 'gemini_key1' ? 'text-amber-200' : 'text-amber-900/80 font-medium'}`}>
                  Chave principal com cota expandida e suporte de faturamento Pay-As-You-Go habilitado.
                </p>
              </button>
              ...
              >
                ...
                <p className={`text-[10px] leading-snug ${preferredEngine === 'gemini_key2' ? 'text-purple-200' : 'text-[#6E6A62]'}`}>
                  Chave dedicada VIP para chamadas do Gemini 2.0 Flash / Lite.
                </p>
              </button>
              ...
              >
                ...
                <p className={`text-[10px] leading-snug ${preferredEngine === 'gemini_key3' ? 'text-blue-200' : 'text-[#6E6A62]'}`}>
                  Chave reserva VIP de alta velocidade e contingência.
                </p>
              </button>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-4">
              ...
              <div className={`p-4 rounded-2xl border transition-all ${
                ...
                <p className="text-[11px] text-amber-900/80 font-medium mb-2">
                  Modelos: <strong className="font-bold">2.0-flash / lite</strong>
                </p>
        ...
        <div className="p-4 rounded-2xl bg-[#F4F3EF] border border-[#E2E0D9] text-xs text-[#4A4741] leading-relaxed">
          ...
          <p className="text-[#6E6A62]">
            {isOwner ? (
              ...
              "Nossa plataforma de estudos conta com infraestrutura de servidores de contingência de alto desempenho em redundância tripla. Caso haja sobrecarga ou oscilação de conectividade em qualquer servidor central, nossa engenharia de tráfego desvia sua requisição silenciosamente em milissegundos para manter seus estudos 100% fluidos, sem interrupções e sem custos extras."
            )}
          </p>
        </div>

        {/* Footer */}
        <div className="mt-6 pt-4 border-t border-[#E2E0D9] flex justify-between items-center">
          ...
          >
            {isOwner ? "Salvar e Fechar" : "Fechar"}
          </Button>
        </div>
